...
static esp_attr_value_t gatts_initial_char_val =
{
...
static void gatts_profile_a_event_handler(esp_gatts_cb_event_t event, esp_gatt_if_t gatts_if, esp_ble_gatts_cb_param_t *param) {
    ...
    case ESP_GATTS_REG_EVT:
    	...
    	for (int i=0; i < b->service_TAM; i++)
    	{
    		uint8_t uuid_service[16] = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, i+1, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x50, 0x05, 0x00};
    ...
    case ESP_GATTS_CREATE_EVT:	
    	...
    	for (int i=0; i < b->service_TAM ; i++)
    	{
			if ( b->service_handle[i] == param->create.service_handle)
			{
	 			for (int j=0; j< b->charact_TAM[i] ; j++)
	 			{
					uint8_t uuid_char[16] = {j, 0x00, 0x00, 0x00, 0x00, 0x00, i+1, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x50, 0x05, 0x00};
